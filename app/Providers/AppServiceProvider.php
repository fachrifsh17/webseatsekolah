...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        $policies = [
            ...
            \App\Models\Semester::class            => \App\Policies\SemesterPolicy::class, // Tambahkan baris ini
            
            // --- Tambahan Wali Kelas & Tingkatan ---
            \App\Models\KelasWaliKelas::class      => \App\Policies\KelasWaliKelasPolicy::class,
            \App\Models\Tingkatan::class           => \App\Policies\TingkatanPolicy::class,
