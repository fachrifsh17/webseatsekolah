    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'guru' => $this->whenLoaded('guru', fn() => [
                'id'      => $this->guru?->id,
                'display' => $this->guru ? ($this->guru->nama . ' (' . $this->guru->nip . ')') : '-'
            ]),

            'mapel' => $this->whenLoaded('mapel', fn() => [
                'id'      => $this->mapel?->id,
                'display' => $this->mapel ? ($this->mapel->jurusan ? $this->mapel->nama_mapel . ' - ' . $this->mapel->jurusan->nama_jurusan : $this->mapel->nama_mapel) : '-'
            ]),
